...
// test Straight with Face Cards

describe("Rank Straight", function () {
  it("Return a straight when hand that includes face cards given", function () {
    var hand = new PokerHand("9c 10s 7d Jd 8h");
    assert.equal(hand.getRank(), "Straight");
  });
});

// test Straight with more Face Cards

describe("Rank Straight", function () {
  it("Return a straight when hand that includes more face cards given", function () {
    var hand = new PokerHand("Ad 10s Jd Qc Kh");
    assert.equal(hand.getRank(), "Straight");
  });
});
